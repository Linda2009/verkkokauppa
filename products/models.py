...
class Category(MPTTModel):
    ...
    slug = models.SlugField(verbose_name=_("Category safe URL"),max_length= 300, unique=True) 
...
class Product(models.Model):
    ...
    slug = models.SlugField(verbose_name=_("Product safe URL"), max_length=255)
    regular_price = models.DecimalField(verbose_name=_("Regular price"), max_digits=20,decimal_places=2)
    discount_price = models.DecimalField(verbose_name=_("Discount price"),max_digits=20,decimal_places=2)
